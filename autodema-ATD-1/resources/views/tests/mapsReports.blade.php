...
<div class="visor-btn-wrapp">
    <div class="visor-btn-inn">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <!-- BUTTON -->
            <li class="visor-btn nav-item">
                <a
            ...
            <li class="visor-btn nav-item">
                <a
                    ...
                    aria-selected="false"><i class="fa fa-area-chart"></i></a>
            </li>
            <!-- BUTTON -->
            <li class="visor-btn nav-item">
                <a
                   ...
                   id="comparative-tab"
                   data-toggle="tab"
                   href="#comparative-section"
                   role="tab"
                   aria-controls="contact"
                   aria-selected="false"><span class="fa fa-connectdevelop"></span></a>
            </li>
        </ul>
    </div>
</div>
            ...
            <div class="tab-pane fade show active" id="map-section" role="tabpanel" aria-labelledby="map-tab">
                <div class="dashboard">
                    <div class="element mapa-wrapp">
                        ...
                        <div class="maps-layers-wrapp">
                            <div class="maps-layers-inn">
                                <div class="maps-layers" id="maps-layers">
                                    <div class="maps-layer bjawg" data-map="bjawg"></div>
                                    <div class="maps-layer topo" data-map="topo"></div>
                                    <div class="maps-layer esriWorldTerrain d-none" data-map="esriWorldTerrain"></div>
                                    <div class="maps-layer esriWorldImagery" data-map="esriWorldImagery"></div>
                                    <div class="maps-layer jawg" data-map="jawg"></div>
                                    <div class="maps-layer active open" data-map="open"></div>
                                </div>
                            </div>
                        </div>
                        <div class="add-all-point-wrapp">
                            <div class="add-all-point-inn">
                        ...
                        <div class="point-resume-wrapp d-none">
                            <div class="add-all-point-inn">
                        ...
                        <div class="grid mapa-inn">
                            <div class="title-visor-wrapp">
                                <div class="title-visor-inn">
                                    <div class="title-visor">
                                        PLATAFORMA DE VIGILANCIA DE LA CALIDAD DEL AGUA
                                ...
                                <div class="d-inline-block visor-filter-points-wrapp" data-filter="reservoir_id">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-form dropdown-services-list" style="z-index: 2000">
                                        ...
                                        @foreach($reservoirs as $reservoir)
                                            <li>
                                                <label class="checkbox">
                                                    <input class="form-check-input service-type-check point_check_input" data-filter-type="reservoir_id" type="checkbox" value="{{ $reservoir->id }}" data-points="{{ $reservoir->samplingPoints->pluck('id')->toJson() }}" checked="checked">{{ $reservoir->name }}
                                                </label>
                                            </li>
                                        @endforeach
                                    </ul>
...
<div class="modal" id="modalInfoPunto">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Estación <span id="mi-estation-name"></span></h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            ...
            <div class="modal-body modal-ajax-content">
                ...
                <div class="modal-body-msg-wrapp">
                    ...
                    <table class="table table-bordered table-samplingPoint-info">
                        <tbody>
                        <tr>
                            <th>UNIDAD HIDROGRÁFICA</th>
                            <td class="spi-hidrographic-unit"></td>
                        </tr>
                        <tr>
                            <th style="max-width: 350px;">UTM</th>
                            <td>
                                Norte: <span class="spi-north"></span><br>
                                Este: <span class="spi-east"></span><br>
                            </td>
                        </tr>
                        <tr>
                            <th>LATITUD/LONGITUD</th>
                            <td>
                                Lat.: <span class="spi-latitude"></span><br>
                                Long.: <span class="spi-longitude"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>ECA</th>
                            <td class="spi-eca-name"></td>
                        </tr>
                        <tr>
                            <th>CUENCA</th>
                            <td class="spi-basin-name"></td>
                        </tr>
                        <tr>
                            <th>EMBALSE</th>
                            <td class="spi-reservoir-name"></td>
                        </tr>
                        <tr>
                            <th>ZONA</th>
                            <td class="spi-zone-name"></td>
                        </tr>
                        @if(auth()->user()->role_id <= 3)
                            <tr>
                                <th>Muestreos</th>
                                <td class="spi-see-links"></td>
                            </tr>
                        @endif
                    </table>
                </div>
...
<script>
    ...
    let sampling_point_data_route = "{{ route('samplingPoints.getInfoAsJson') }}";
    ...
    $(document).ready(function() {
        ...
        var layers = {
            ...
            "bjawg": {
                ...
                "tile": "https://tile.jawg.io/5ed086f5-2491-4882-944c-56dc27ef6991/{z}/{x}/{y}{r}.png?access-token=5cHz1n3aZIsknm3pJyAMip8VfoTJgMK1w3i8Kh3zP84NyCp3hk62t5uMLUrv9knj",
                minZoom: 0,
                maxZoom: 22,
                subdomains: 'abcd',
                accessToken: '5cHz1n3aZIsknm3pJyAMip8VfoTJgMK1w3i8Kh3zP84NyCp3hk62t5uMLUrv9knj'
            },
            "jawg": {
                "attribution": '<a href="http://jawg.io" title="Tiles Courtesy of Jawg Maps" target="_blank">&copy; <b>Jawg</b>Maps</a> &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
                "tile": "https://{s}.tile.jawg.io/jawg-streets/{z}/{x}/{y}{r}.png?access-token=5cHz1n3aZIsknm3pJyAMip8VfoTJgMK1w3i8Kh3zP84NyCp3hk62t5uMLUrv9knj",
                minZoom: 0,
                maxZoom: 22,
                subdomains: 'abcd',
                accessToken: '5cHz1n3aZIsknm3pJyAMip8VfoTJgMK1w3i8Kh3zP84NyCp3hk62t5uMLUrv9knj'
            ...
            "esriWorldImagery": {
                ...
                "maxZoom": 17,
                "minZoom": 0,
                "image": "esriWorldImagery.png",
                "name": "esriWorldImagery",
            },
        };
        var mymap = L.map('mapid').setView([-16.18054, -71.2355378], 12.1);
        var baseTilelayer = L.tileLayer("http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
        ...
        function onMarkerClickPopupChart(e) {
            ...
            let $moreInfoBtn = $('<a/>', {
                ...
                class: 'more-point-info-modal-btn',
                href: '#modalInfoPunto',
                'data-toggle': 'modal',
                'data-point': index,
                'data-name': name,
                'data-target': '#modalInfoPunto',
            }).click(function() {
                console.log(index);
                console.log(name);
                ...
                $("#mi-estation-name").html(name);
                $.ajax({
                    type: 'GET', //THIS NEEDS TO BE GET
                    url: sampling_point_data_route,
                    tryCount : 0,
                    retryLimit : 3,
                    dataType : "json",
                    data:{
                    ...
                    success: function (data) {
                        ...
                        $("#mi-estation-name").prepend(data.type_title+": ");
                        $(".spi-hidrographic-unit").html(data.hidrographic_unit);
                        $(".spi-north").html(data.north);
                        $(".spi-east").html(data.east);
                        $(".spi-latitude").html(data.latitude);
                        $(".spi-longitude").html(data.longitude);
                        $(".spi-eca-name").html(data.eca.name);
                        $(".spi-basin-name").html(data.basin.name);
                        $(".spi-reservoir-name").html(data.reservoir.name);
                        $(".spi-zone-name").html(data.zone.name);
                        $(".spi-see-links").html(data.links);
            ...
            $("#pcc").html(
                ...
                "<b>E:</b> " + north + "<br/>" +
                "<b>N:</b> " + east + "<br/>"
            ).append($addBtn).append("</br>").append($moreInfoBtn);
        }
...
/*
        ...
        jQuery('body').on('click', '.maps-layer', function() {
            const mapLayer = jQuery(this);
            const map_id = mapLayer.attr("data-map");
            const is_active = jQuery(this).hasClass('active');
            if(!is_active){
                jQuery('.maps-layer').removeClass('active');
                mapLayer.addClass('active');
                const layerObject = layers[map_id];
                mymap.attributionControl.setPrefix(layerObject.attribution);
                baseTilelayer.setUrl(layerObject.tile);
                mapLayer.appendTo(jQuery("#maps-layers"));
                jQuery('#maps-layers').removeClass('opened');
            }else{
                jQuery('#maps-layers').addClass('opened');
            }
