! function(t) {
    ...
    var r = n(1),
        i = function() {
            function t(t, e) {
                ...
                var n = e.regressions;
                this.chart = t, this.dataset = e, this.normalizedData = this._normalizeData(e.data), this.sections = this._createMetaSections(n), this._calculate()
            }
            return t.prototype._normalizeData = function(t, changeAxisToNumbers = true) {
                var e = this;
                edata = t;
                let a = t.map((function(t, n) {
                    var r;
                    /*
                    if("object" == typeof t.x){
                        t.x = n;
                    }*/
                    if(changeAxisToNumbers){
                        console.log(t.x);
                        tx.push(t.x);
                        t.x = n;
                        console.log(tx);
                    ...
                    console.log("------------------");
                    console.log("number" == typeof t || null == t || void 0 === t ? r = [n, t] : (e.isXY = !0, r = [t.x, t.y]), r);
                    console.log(t);
                    console.log(n);
                    console.log(typeof t);
                    console.log(typeof t.x);
                    console.log(t.x);
                    return "number" == typeof t || null == t || void 0 === t ? r = [n, t] : (e.isXY = !0, r = [t.x, t.y]), r
                }))
                console.log(a);
                return a;
                ...
                this.sections.forEach((function(t) {
                    console.log("-c-b-ccccccc-a-a-a-a-a");
                    return t.calculate()
                }))
                ...
                if (void 0 === this.topY) {
                    ...
                    Object.keys(n).forEach((function(r) {
                        console.log("x" == r[0] && (t = n[r]) || (e = n[r]));
                        console.log(n[r]);
                        console.log(r[0]);
                        return "x" == r[0] && (t = n[r]) || (e = n[r])
                    })), this.topY = e.top, this.bottomY = e.bottom, this.getXY = function(n, r) {
                        console.log(t.getPixelForValue(n, void 0, void 0, !0));
                        return {
            ...
            }, t.prototype.drawRegressions = function(a) {
                ...
                console.log("-b-b-b-a-a-a-b--a-a-a-a-a");
                console.log(this.chart);
                console.log(t);
                console.log(a);

                this.chart.chart.options.showLines = false;
                console.log(this._normalizeData(edata, false));
        ...
        o = function() {
            function t(t, e) {
                ...
                var n, r, o, a, s = e.chart,
                    c = e.dataset,
                    u = (n = ["type", "calculation", "line", "extendPredictions", "copy"], a = (r = s.config.options) && (o = r.plugins) && o.regressions || {}, function t(e) {
                        ...
                        return e.forEach((function(e) {
                            n.forEach((function(n) {
                                var r = n[e],
                                    o = typeof r;
                                "undefined" != o && (Array.isArray(r) || "object" != o || null == r ? i[e] = r : i[e] = Object.assign({}, i[e], t(Object.keys(r), r)))
                            }))
                        })), i
            ...
            return t.prototype._validateType = function() {
                ...
                if (r.points = t.map((function(t) {
                    ...
                    r.points.forEach((function(t, r) {
                        ...
                        var c = t[0],
                            u = t[1],
                            l = r + e.startIndex;
                        (l < n.startIndex || l > n.endIndex) && ("all" == i || "last" == i && l == e.endIndex || "empty" == i && !o[l]) && (e.copy.maxValue && (u = Math.min(e.copy.maxValue, u)), void 0 !== e.copy.minValue && (u = Math.max(e.copy.minValue, u)), a[l] = s ? {
                            x: c,
                            y: u
                        } : u)
                    }))
                ...
                for (var e = 0, n = this._meta.sections.length; e < n; e++) {
                    var r = this._meta.sections[e],
                        i = r == this;
                    if ((i && "copy" != this.type[0] || !i && this.extendPredictions) && r.drawRange(t, this.startIndex, this.endIndex, !i), i) break
                }
    ...
    i = [t], void 0 === (o = "function" == typeof(r = function(t) {
        ...
        var a = {
            linear: function(t, e) {
                console.log("qqqqqq");
                for (var n = [0, 0, 0, 0, 0], r = 0, a = 0; a < t.length; a++) null !== t[a][1] && (r++, n[0] += t[a][0], n[1] += t[a][1], n[2] += t[a][0] * t[a][0], n[3] += t[a][0] * t[a][1], n[4] += t[a][1] * t[a][1]);
                var s = r * n[2] - n[0] * n[0],
                    c = r * n[3] - n[0] * n[1],
            ...
            exponential: function(t, e) {
                for (var n = [0, 0, 0, 0, 0, 0], r = 0; r < t.length; r++) null !== t[r][1] && (n[0] += t[r][0], n[1] += t[r][1], n[2] += t[r][0] * t[r][0] * t[r][1], n[3] += t[r][1] * Math.log(t[r][1]), n[4] += t[r][0] * t[r][1] * Math.log(t[r][1]), n[5] += t[r][0] * t[r][1]);
            ...
            logarithmic: function(t, e) {
                for (var n = [0, 0, 0, 0], r = t.length, a = 0; a < r; a++) null !== t[a][1] && (n[0] += Math.log(t[a][0]), n[1] += t[a][1] * Math.log(t[a][0]), n[2] += t[a][1], n[3] += Math.pow(Math.log(t[a][0]), 2));
                var s = o((r * n[1] - n[2] * n[0]) / (r * n[3] - n[0] * n[0]), e.precision),
            ...
            power: function(t, e) {
                for (var n = [0, 0, 0, 0, 0], r = t.length, a = 0; a < r; a++) null !== t[a][1] && (n[0] += Math.log(t[a][0]), n[1] += Math.log(t[a][1]) * Math.log(t[a][0]), n[2] += Math.log(t[a][1]), n[3] += Math.pow(Math.log(t[a][0]), 2));
            ...
            polynomial: function(t, e) {
                for (var r = [], a = [], s = 0, c = 0, u = t.length, l = e.order + 1, p = 0; p < l; p++) {
                    for (var h = 0; h < u; h++) null !== t[h][1] && (s += Math.pow(t[h][0], p) * t[h][1]);
                    r.push(s), s = 0;
                    for (var f = [], d = 0; d < l; d++) {
                        for (var y = 0; y < u; y++) null !== t[y][1] && (c += Math.pow(t[y][0], p + d));
                        f.push(c), c = 0
                    }
                    a.push(f)
                }
                ...
                for (var v = function(t, e) {
                    for (var n = t, r = t.length - 1, i = [e], o = 0; o < r; o++) {
                        for (var a = o, s = o + 1; s < r; s++) Math.abs(n[o][s]) > Math.abs(n[o][a]) && (a = s);
                        for (var c = o; c < r + 1; c++) {
                            var u = n[c][o];
                            n[c][o] = n[c][a], n[c][a] = u
                        }
                        for (var l = o + 1; l < r; l++)
                            for (var p = r; p >= o; p--) n[p][l] -= n[p][o] * n[o][l] / n[o][o]
                    }
                    for (var h = r - 1; h >= 0; h--) {
                        for (var f = 0, d = h + 1; d < r; d++) f += n[d][h] * i[d];
                        i[h] = (n[r][h] - f) / n[h][h]
                    }
                    return i
                }(a, l).map((function(t) {
                    ...
                    return [o(t, e.precision), o(v.reduce((function(e, n, r) {
                        return e + n * Math.pow(t, r)
                    }), 0), e.precision)]
                }, x = t.map((function(t) {
                    return g(t[0])
                })), b = "y = ", m = v.length - 1; m >= 0; m--) b += m > 1 ? v[m] + "x^" + m + " + " : 1 === m ? v[m] + "x + " : v[m];
                return {
                    string: b,
                    points: x,
                    predict: g,
    ...
    var r = n(0),
        ...
        a = function() {
            ...
            return t.prototype.beforeInit = function(t) {
                ...
                var n, o, a, c = (n = t.config.options) && (o = n.plugins) && (a = o.regressions) && a.onCompleteCalculation;
                s(t, (function(e, n, o) {
